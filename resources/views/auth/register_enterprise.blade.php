...
@section('content')
    <div class="justify-content-center">
        <div class="">
            <div class="card">
                <x-breadcrumb title="Register Enterprise"/>

                <div class="card-body">
                    <form method="POST" action="{{ route('enterprise') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <label for="description"></label><textarea id="description" type="text" class="form-control @error('description') is-invalid @enderror" name="description"  ></textarea>
                                @error('description')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
