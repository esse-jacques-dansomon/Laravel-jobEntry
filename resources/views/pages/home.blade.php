            ...
            <div class="tab-class text-center wow fadeInUp" data-wow-delay="0.3s">
                <ul class="nav nav-pills d-inline-flex justify-content-center border-bottom mb-5">
                    @foreach($typesJobs as $typeJob)
                        <li class="nav-item">
                            <a class="d-flex align-items-center text-start mx-3 ms-0 pb-3 {{ $loop->first ? 'active' : '' }}" data-bs-toggle="pill" href="#tab-{{ $typeJob['id'] }}">
        ...
        <div class="container">
            ...
            <div class="owl-carousel testimonial-carousel">
                @foreach($testimonies as $testimonial)
                    <x-testimonial-card-view :testimonial="$testimonial" />
                @endforeach
            </div>
        </div>
    </div>
